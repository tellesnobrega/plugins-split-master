...
class DeployCDHV5130(base.SaharaTestCase):

    def setUp(self):
        super(DeployCDHV5130, self).setUp()
    ...
    def tearDown(self):
        ...
        super(DeployCDHV5130, self).tearDown()

    @mock.patch("sahara.plugins.utils.get_instances")
    @mock.patch("sahara.plugins.cdh.v5_13_0.deploy.CU")
    ...
    @mock.patch("sahara.plugins.cdh.v5_13_0.deploy._start_roles")
    @mock.patch("sahara.plugins.cdh.v5_13_0.deploy.CU")
    ...
    @mock.patch("sahara.plugins.cdh.v5_13_0.deploy._finish_cluster_starting")
    @mock.patch("sahara.plugins.cdh.v5_13_0.deploy._prepare_cluster")
    @mock.patch("sahara.plugins.cdh.v5_13_0.deploy.CU")
