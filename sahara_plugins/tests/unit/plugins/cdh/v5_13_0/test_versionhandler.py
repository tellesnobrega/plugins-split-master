...
from sahara.plugins.cdh.v5_13_0 import versionhandler
from sahara.tests.unit import base


class VersionHandlerTestCase(base.SaharaTestCase):

    plugin_path = "sahara.plugins.cdh.v5_13_0."
    cloudera_utils_path = plugin_path + "cloudera_utils.ClouderaUtilsV5130."
    plugin_utils_path = plugin_path + "plugin_utils.PluginUtilsV5130."
